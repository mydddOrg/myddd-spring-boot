...
public class TestAliYunMediaStorage {
    ...
    void testMediaExtraToString(){
        MediaExtra mediaExtra = new AliYunMediaExtra(UUID.randomUUID().toString());
    ...
    @Test
    @Disabled("需要提供真实的KEY与Secret才能运行此测试")
    void testUploadToStorage() throws IOException {
        String sourcePath = Objects.requireNonNull(TestAliYunMediaStorage.class.getClassLoader().getResource("my_avatar.png")).getPath();

...
@SpringBootTest(classes = QCloudMediaStorageTest.class)
...
@Disabled
public class QCloudMediaStorageTest {
    ...
    void testUploadToStorage() throws IOException {
        String sourcePath = Objects.requireNonNull(QCloudMediaStorageTest.class.getClassLoader().getResource("my_avatar.png")).getPath();

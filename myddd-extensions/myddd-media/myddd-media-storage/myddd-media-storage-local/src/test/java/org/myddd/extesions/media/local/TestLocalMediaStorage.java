...
class TestLocalMediaStorage extends TestApplication {
    ...
    void testUploadToStorage() throws IOException {
        String sourcePath = Objects.requireNonNull(TestLocalMediaStorage.class.getClassLoader().getResource("my_avatar.png")).getPath();

...
public class PermissionGroupApplicationGrpcTest extends AbstractGrpcTest {
    ...
    private PermissionGroupApplicationGrpc.PermissionGroupApplicationBlockingStub permissionGroupApplication = PermissionGroupApplicationGrpc.newBlockingStub(managedChannel);
    ...
    void testCreatePermissionGroup() {
        ...
        Assertions.assertThrows(StatusRuntimeException.class,() -> permissionGroupApplication.createPermissionGroup(notValidPermissionGroupDto));
    }
